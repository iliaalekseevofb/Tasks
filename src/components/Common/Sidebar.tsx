...
const Sidebar = (props: SidebarProps) => {
  return (
    <div className="fixed z-10 top-14 left-0 bottom-0 w-64 h-screen py-6 border-r-2 border-secondaryBgHover bg-secondaryBgHover bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20">
