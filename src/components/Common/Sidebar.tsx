...
const Sidebar = () => {
  ...
  return (
    <div className={`fixed z-10 top-14 left-0 bottom-0 w-64 h-screen py-6 ${isOpenSidebar ? 'translate-x-0' : '-translate-x-full'} ease-in-out duration-200 border-r-2 border-secondaryBgHover bg-secondaryBgHover bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20`}>
