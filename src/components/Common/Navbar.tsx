  ...
  return (
    <nav className='fixed z-10 top-0 right-0 left-0 h-12 px-6 flex justify-between items-center bg-secondaryBg'>
      <section className='flex items-center text-iconsColor text-sm font-semibold'>
        <button className='p-1 rounded-standard mr-4 hover:bg-secondaryBgHover transition-colors duration-200'>
          <FiMenu size={24} />
        </button>
        <button className='py-1 px-2 rounded-standard mr-4 flex items-center hover:bg-secondaryBgHover transition-colors duration-200'>
