...
const NavbarMobile = () => {
  return (
    <div className='w-full h-full px-5 flex justify-between items-center sm:hidden text-3xl bg-mainBg bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20'>
      {/* Dashboard */}
      <button className='h-navItemMobile px-1 flex justify-center items-center rounded-standard hover:bg-secondaryBgHover transition-colors duration-200'>
        <RiLayoutMasonryFill className='w-iconSizeMobile h-iconSizeMobile sm:mr-1 text-iconsColor' />
        <h6 className='hidden sm:block'>Dashboard</h6>
      </button>
      {/* Collection */}
      <button className='h-navItemMobile px-1 flex justify-center items-center rounded-standard hover:bg-secondaryBgHover transition-colors duration-200'>
        <HiFolderOpen className='w-iconSizeMobile h-iconSizeMobile sm:mr-1 text-iconsColor' />
      ...
      {/* Notifications icon */}
      <button className='w-navItemMobile h-navItemMobile flex justify-center items-center rounded-standard text-iconsColor hover:bg-secondaryBgHover transition-colors duration-200'>
