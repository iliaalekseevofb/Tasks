  ...
  return (
    <div className='w-full h-full px-5 hidden sm:flex justify-between items-center border-b-2 border-mainBg bg-secondaryBgHover bg-clip-padding backdrop-filter backdrop-blur-md bg-opacity-20'>
      <section className='flex items-center text-iconsColor text-base font-semibold'>
        ...
        {/* Dashboard */}
        <button className='h-navItemDesktop px-1 mr-3 flex justify-center items-center rounded-standard hover:bg-secondaryBgHover transition-colors duration-200'>
          <RiLayoutMasonryFill className='w-iconSizeDesktop h-iconSizeDesktop sm:mr-1' />
          <h6 className='hidden sm:block'>Dashboard</h6>
        </button>
        {/* Collection */}
        <button className='h-navItemDesktop px-1 flex justify-center items-center rounded-standard hover:bg-secondaryBgHover transition-colors duration-200'>
      ...
      <section className='flex items-center'>
        ...
        {/* Profile */}
        <button className='w-navItemDesktop h-navItemDesktop rounded-full overflow-hidden'>
